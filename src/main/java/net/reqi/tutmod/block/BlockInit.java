...
import net.reqi.tutmod.block.custom.SoundBlock;
...
public class BlockInit {
    ...
    //Add weird block and its blockitem
    public static final RegistryObject<Block> WEIRD_BLOCK = BLOCKS.register("weird_block", () -> new SoundBlock(
            BlockBehaviour.Properties.of()
                    .mapColor(MapColor.COLOR_GREEN)
                    .strength(6f, 1000f)
                    .instrument(NoteBlockInstrument.DRAGON)
    ...
    public static final RegistryObject<Item> WEIRD_BLOCK_ITEM = ItemInit.ITEMS.register("weird_block_item",
            () -> new BlockItem(WEIRD_BLOCK.get(),new Item.Properties()
                    .rarity(Rarity.EPIC)
            ));
